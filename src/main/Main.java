...
public class Main {
        ...
        for(int i=0; i<myFolderFileList.length; i++)
        {
            ...
            for (int y = 0; y < height; y++) {
                for (int x = 0; x < width; x++) {
                    ...
                    if((r>200 && g>200 && b>200) && (r1<20 && g1<20 && b1<20)) // dataset bole nonskin amio boli nonskin
                        tn++;
                    if(!(r>200 && g>200 && b>200) && (r1<20 && g1<20 && b1<20)) // dataset bole skin ami boli nonskin
                        fp++;
                    if(!(r>200 && g>200 && b>200) && !(r1<20 && g1<20 && b1<20)) // dataset bole skin amio boli skin
                        tp++;
                    if((r>200 && g>200 && b>200) && !(r1<20 && g1<20 && b1<20)) // dataset bole nonskin ami boli skin
                        fn++;
    ...
    public static void main(String[] args) throws IOException {
        ...
        initializeAra();
        readImages(new File("C:\\Users\\88017\\Downloads\\ibtd-20200115T095110Z-001\\ibtd\\NonMask\\"), new File("C:\\Users\\88017\\Downloads\\ibtd-20200115T095110Z-001\\ibtd\\Mask\\"));
        calculateProbability();
        System.out.println("Finished training process");

        File testNonMaskImage = new File("C:\\Users\\88017\\Downloads\\ibtd-20200115T095110Z-001\\ibtd\\tmpnonmask\\");
        ...
        try {
            for (int i = 0; i < testNonMaskImage.length(); i++) {
                ...
                testImage(testNonMaskImageFilePath[i], new File("C:\\Users\\88017\\Downloads\\ibtd-20200115T095110Z-001\\ibtd\\tmpmask\\" + testNonMaskImageFilePath[i].getName()));
            }
        }catch (Exception e)
        {
        ...
        float accurecy = calculateAccurecy(new File("C:\\Users\\88017\\Downloads\\ibtd-20200115T095110Z-001\\ibtd\\tmpmask\\"), new File("C:\\Users\\88017\\Downloads\\ibtd-20200115T095110Z-001\\ibtd\\tmpnonmask\\")) + A;
